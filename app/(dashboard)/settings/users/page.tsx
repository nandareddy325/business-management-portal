  ...
  return (
    <div className="space-y-5 p-4 md:p-6 max-w-2xl">
      ...
      <div>
        ...
        <h1 className="text-xl font-black text-[#1C1712]">My Account</h1>
      ...
      <div className="rounded-2xl overflow-hidden" style={cardStyle}>
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <div className="relative" style={disabledStyle}>
              {user?.email}
            ...
            <p className="text-[11px] text-[#9A8F82] mt-1">Email cannot be changed.</p>
          </div>
          <div>
