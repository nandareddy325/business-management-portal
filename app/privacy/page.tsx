              ...
              content: [
                {
                  ...
                  text: 'When you sign up, we collect your name, email address, phone number, and company name. This information is necessary to create and manage your account.'
                },
                {
                  sub: 'Business Data',
                  text: 'We store the data you enter into GK CRM — leads, customers, invoices, employee records, attendance, and other business information. This data belongs to you and is stored securely.'
                },
                {
                  sub: 'Usage Data',
                  text: 'We collect information about how you use GK CRM, including pages visited, features used, and actions taken. This helps us improve the product.'
                },
                {
                  sub: 'Payment Information',
                  text: 'Payments are processed by Razorpay. We do not store your card details. We only receive payment confirmation and transaction IDs.'
                },
              ]
            },
            {
              ...
              content: [
                {
                  ...
                  text: 'We use Supabase with Row Level Security (RLS). Your company\'s data is completely isolated — other companies cannot access your data under any circumstances.'
                },
                {
                  sub: 'Encryption',
                  text: 'All data is encrypted in transit using HTTPS/TLS. Sensitive data is encrypted at rest in our database.'
                },
                {
                  sub: 'Access Controls',
                  text: 'Role-based access ensures that employees only see data they are authorized to view. Admin controls allow you to manage permissions.'
                },
              ]
            },
            {
              ...
              content: [
                {
                  ...
                  text: 'We never sell, rent, or trade your personal information or business data to third parties for marketing purposes.'
                },
                {
                  sub: 'Service Providers',
                  text: 'We share data only with trusted service providers who help us operate GK CRM — including Supabase (database), Razorpay (payments), and Vercel (hosting). These providers are bound by strict data protection agreements.'
                },
                {
                  sub: 'Legal Requirements',
                  text: 'We may disclose data if required by Indian law, court order, or government authority.'
                },
              ]
            },
            {
              ...
              content: [
                ...
                },
                {
                  ...
                  text: 'When you delete your account, we permanently delete all associated data within 30 days, except where retention is required by law.'
                },
              ]
            },
            {
              ...
              content: [
                {
                  ...
                  text: 'We use cookies only for essential functions — authentication sessions and security. We do not use advertising or tracking cookies.'
                },
              ]
            },
            {
              ...
              content: [
                {
                  sub: 'Age Restriction',
                  text: 'GK CRM is intended for business use and is not directed at children under 18 years of age. We do not knowingly collect data from minors.'
                },
              ]
            },
            {
              ...
              content: [
                {
                  sub: 'Updates',
                  text: 'We may update this Privacy Policy from time to time. We will notify you of significant changes via email or in-app notification. Continued use of GK CRM after changes constitutes acceptance of the updated policy.'
                },
              ]
            },
            {
              ...
              content: [
                {
                  ...
                  text: 'For any privacy-related questions or requests, contact us at: privacy@gkcrm.in or +91 98765 43210. We are based in Hyderabad, Telangana, India.'
                },
              ]
            },
          ].map((section) => (
