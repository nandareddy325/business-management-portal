  ...
  try {
    ...
    switch (event.event) {
      ...
      case 'subscription.charged': {
        ...
        const planName = (subscriptionEntity.notes?.plan_name || 'starter') as keyof typeof PLANS
        ...
        const planLimits = PLANS[planName] ?? PLANS.starter
        ...
        console.log(`✅ Subscription activated/charged for company ${companyId} (plan: ${planName}, max_users: ${planLimits.maxUsers})`)
        break
      }
