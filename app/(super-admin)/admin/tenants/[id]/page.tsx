...
import {
  ...
  CreditCard, Hash, CheckCircle2, XCircle, Crown, DollarSign
} from 'lucide-react'
  ...
  const subscriptionRows = [
    ...
    },
    {
      ...
      value: subscription?.activated_at
        ? new Date(subscription.activated_at).toLocaleDateString('en-IN', { day: 'numeric', month: 'long', year: 'numeric' })
        : 'Not yet activated',
      icon: Calendar,
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0D]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-6 sm:py-8 space-y-6">
        ...
        {/* Company Details + Subscription Info side by side, same style */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white/[0.03] ring-1 ring-white/8 rounded-2xl overflow-hidden">
            <div className="flex items-center gap-2.5 px-5 sm:px-6 py-4 border-b border-white/5">
              ...
              <h2 className="text-sm font-semibold text-white">Subscription Info</h2>
            </div>
            <div className="divide-y divide-white/[0.04]">
              {subscriptionRows.map(item => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-xs sm:text-sm font-semibold font-mono text-right truncate max-w-[55%] text-white/70">
                      {item.value}
                    </p>
                  </div>
                )
